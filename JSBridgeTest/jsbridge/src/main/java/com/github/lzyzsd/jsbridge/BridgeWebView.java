...
public class BridgeWebView extends WebView implements WebViewJavascriptBridge {
     ...
     * router跳转的拦截回调
     */
    private OnRouterCallback onRouterCallback;
    ...
    private void init() {
        ...
        // BridgeWebView 的setWebViewClient()将使用bridgeWebViewClient做中转, 这里要使用super.seWebViewClient()方法
    ...
    private void registerRouter() {
        // 统一处理js的router回掉
        registerHandler("router", new BridgeHandler() {
            @Override
    ...
    public void setOnRouterCallback(OnRouterCallback onRouterCallback) {
        this.onRouterCallback = onRouterCallback;
    }

    @Override
    public void setWebViewClient(WebViewClient client) {
        bridgeWebViewClient.setTargetWebViewClient(client);
    }
    ...
    public interface OnRouterCallback {
        boolean handleRouter(String url, CallBackFunction function);
    }
}
